"""FROZEN, TEST-ONLY copy of the Ed25519 reference implementation that `ed25519.py` shipped before v1.20.1 (#70).
Never imported by `hv`. tests/test_ed25519.py checks the fast module against it: same accept set, byte-identical
signatures. Do not edit or "fix" it: its exact behaviour, including its permissive decoding, is the specification.
"""
import hashlib
